      ...
      <div class="border-1">
        <div class="border-2">
          ...
          <div class="row" style="margin-bottom: 10px;">
            <div class="column25">
               <img width="130" alt="" style="margin-top: 0.153in;" src="{{asset('logo/qr.png')}}" alt="">
            </div>
            <div class="column50" style="text-align: center;">
                      <img src="{{asset('logo/govt.png')}}" width="80" height="80" alt="">
                                            ...
                                            <h3 class="sonod-title" style="margin-bottom: 0px !important;color: #fff;">উত্তরাধিকার সনদ</h3>
            </div>
            <div class="column25">
          ...
          <div class="row" style="margin-bottom: 10px;">
            ...
            <div class="column50" style="margin-bottom: 7px;">
                <h2 style="font-size: 18px;margin-bottom: 0px !important;margin-top: 0px !important;">সনদ নং :</h2>
                                   
                
            </div>
            <div class="column50" style="text-align: right;margin-bottom: 7px;">
                                    <h2 style="font-size: 18px;margin-bottom: 0px !important;margin-top: 0px !important;">ইস্যু তারিখঃ ২০-১১-২০২০ ইং</h2>
                
            </div>
             <div style="width: 100%;text-align: justify;font-size: 17px;font-weight: normal;margin-bottom: 7px;">
                                       স্থানীয় ৪ নং ওয়ার্ড সদস্য কর্তৃক সুপারিশক্রমে এই মর্মে উত্তরাধিকার সনদপত্র প্রদান
                                করা যাচ্ছে যে, মৃত: মো: আবদুল গণি,
                                পিতা / স্বামী : মৃত: আবদুল গণি, গ্রাম: আবদুল গণি, ডাকঘর: তিস্তা, জেলা: লালমনিরহাট,
                                অত্র পৌরসভার ০৪ নং ওয়ার্ডের স্থায়ী
                                বাসিন্দা ছিলেন। মৃত্যুকালে তিনি নিম্নলিখিত উত্তরাধিকারগণকে রেখে যান।
                                </div>
            
          </div>

           <table class="warish_table" style="text-align: left;margin-bottom: 10px;width: 100%;border-collapse: collapse;" border="1">
                                     <tr>
