...
<body class="skin-default">
    <div class="preloader">
        <div class="loader_img"><img src="{{ asset('img/loader.gif') }}" alt="loading..." height="64"
           width="64">
       </div>
   </div>
...
<script src="{{ asset('js/admin/form_elements.js') }}"></script>
    ...
    <!-- flip --->
    <script type="text/javascript" src="{{asset('js/custom_js/flip.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('js/custom_js/dashboard1.js')}}"></script>
    @yield('js')
