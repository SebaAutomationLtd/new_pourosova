                    ...
                    <form action="{{ route('admin.web.contact.uno.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"   placeholder="ইমেইল">
                                @error('email')
                                    <small class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </small>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('contact') is-invalid @enderror"  name="contact" placeholder="মোবাইল নং">
                                @error('contact')
                                    <small class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </small>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control @error('telephone') is-invalid @enderror"  name="telephone" placeholder="টেলিফোন">
                                @error('telephone')
                                    <small class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </small>
