                ...
                <div class="card-body">
                    <form action="{{ route('admin.web.left.banner.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="শিরোনাম">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <select id="type" name="information_type" value="{{ old('information_type') }}" class="custom-select @error('information_type') is-invalid @enderror">
                        ...
                        <div id="desc" class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"  name="description" placeholder="বর্ণনা লিখুন">{{ old('description') }}</textarea>
                            @error('description')
                                <small class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </small>
                    ...
                    <div class="">
                        <div class="table-data">
                            <table class="table table-striped table-bordered responsive nowrap table-hover"
                                ...
                                <tbody>
                                    @foreach($left_banners as $key=>$banner)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $banner->title }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a href="{{ route('admin.web.left.banner.edit',$banner->id)}}" data-placement="left" title="এডিট করুন" data="tooltip"
                                                        class="text-primary dropdown-item" href="#">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a data-placement="left" title="ডিলেট করুন" data="tooltip"
                                                        class="text-danger dropdown-item" href="{{ route('admin.web.left.banner.delete',$banner->id)}}">
