        ...
        <div class="col-md-12">
            <div class="card main-chart">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.web.councilor.update',$councilor->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="">নাম</label>
                                <input type="text" class="form-control" name="name" placeholder="নাম" value="{{ $councilor->name }}">
                                @error('name')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="place" value="{{  $councilor->place }}" class="form-control" placeholder="স্থান">
                                @error('place')
                                    <small class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </small>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" class="form-control" name="contact" value="{{ $councilor->contact }}">
                                @error('contact')
                                    <small class="text-danger">
                                        <strong>{{ $message }}</strong>
                                    </small>
                        ...
                        <div class="form-group">
                            <textarea id="summernote" name="description" class="form-control @error('description') is-invalid @enderror"  placeholder="দৈর্ঘ পরিমান" >{{ $councilor->description }}</textarea>
                            @error('description')
                                <small class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </small>
