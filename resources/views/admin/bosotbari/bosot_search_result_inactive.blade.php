                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
  <form action="{{URL::to('/bosot-search-result-inactive')}}" method="get" id="bosottableinactive">
                                   @csrf
                                <div class="row">
...
serverSide: true,
ajax: {
url: "{{ url('bosot-search-result-inactive') }}",
type: 'GET',
data: function (d) {
...
// });
    $('#bosottableinactive').on('submit', function(e) {
        e.preventDefault();
