        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row mb-2" style="margin-top: 20px;">
                    <div class="col-sm-6">
                        <h5>
ব্যাবসা প্রতিষ্ঠান নিবন্ধন পরিচালনা করুন </h5>
                    </div>
                   <!--  <div class="col-sm-6">
                        ...
                        <div class="card card-warning">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"> ব্যাবসা প্রতিষ্ঠান নিবন্ধন টেবিল<a href=""
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
  <form action="{{URL::to('business-holding-search-result-inactive')}}" method="get" id="bosottable">
                                   @csrf
                                <div class="row">
...
serverSide: true,
ajax: {
url: "{{ url('business-search-result-inactive') }}",
type: 'GET',
data: function (d) {
