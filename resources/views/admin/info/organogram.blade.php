    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card main-chart">
                ...
                <div class="card-body">
                    <form action="{{route('admin.web.info.organogram.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a data-placement="left" title="এডিট করুন" data="tooltip"
                                                        class="text-primary dropdown-item" href="{{route('admin.web.info.organogram.edit',$organogram->id ?? '')}}">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a data-placement="left" title="ডিলেট করুন" data="tooltip"
                                                        class="text-danger dropdown-item" href="{{route('admin.web.info.organogram.delete',$organogram->id ?? '')}}">
