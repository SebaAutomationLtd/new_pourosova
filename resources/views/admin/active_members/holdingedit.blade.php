        ...
        <section class="content  card card-primary">
            <div class="container-fluid">
                <div class="row mb-2" style="margin-top: 20px">
                    <div class="col-sm-6">
                        <h4> বাণিজ্যিক হোল্ডিং আপডেট করুন</h4>
                    </div>
                    <!-- <div class="col-sm-6">
            ...
            @endif
                        <div class=" website-form form-group">
                            ...
                            <form role="form" action="{{ route('update.business-holding', $user->id) }}" method="post"
                ...
                <input class="form-control" type="date" value="{{ old('dob',$user->dob) }}" name="dob">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="number_room" value="{{ old('number_room',$user->total_room) }}"
                                                    class="form-control" id="total_room" placeholder="রুম পরিমাণ"
                                     ...
                                     $stalls = DB::table('business_stalls')->where('business_holding_id',$user->id)->get();
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered table-striped ml-3" id="stallSection">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" value="{{$stall->id}}"  name="stall_id[]">
                                <tr id="">
                    <td width="10%">
                        <input class="form-control" type="text" name="stall_no[]" readonly value="{{old('stall_no',$stall->stall_no)}}">
                    </td>
                    <td width="12%">
                        <select id="ownership_" name="ownership[]" class="form-control">
                            <option {!! old('ownership', $stall->ownership ) == 'self' ? 'selected="selected"' : '' !!} value="self">নিজের</option>
                            <option {!! old('ownership', $stall->ownership ) == 'rent' ? 'selected="selected"' : '' !!} value="rent">ভাড়া</option>
                        </select>
                    </td>
                    <td width="20%">
                        <input class="form-control" name="stall_nid[]" value="{{old('stall_nid',$stall->stall_nid)}}" type="number" maxlength="20">
                    </td>
                    <td width="20%">
                        <input class="form-control" name="stall_date[]" value="{{old('stall_date',$stall->stall_date)}}" type="date">
                    </td>
                    <td width="20%%">
                        <input class="form-control" name="stall_phone[]" value="{{old('stall_phone',$stall->stall_phone)}}" type="number" maxlength="11">
                    </td>
                    <td width="10%">
                        <input class="form-control" id="rent_" value="{{old('stall_rent',$stall->stall_rent)}}" onkeyup="calculateRent()" name="stall_rent[]" type="number">
                    </td>
                    <td width="10%">
                        <input class="form-control" id="tax_" value="{{old('stall_tax',$stall->stall_tax)}}" name="stall_tax[]" readonly type="number"></td>
                    </tr>
                    @endforeach
                    @endif
                            </tbody>
